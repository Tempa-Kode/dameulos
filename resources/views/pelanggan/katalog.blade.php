...
@section('content')
    ...
    <section class="container my-5">
        ...
        <a href="{{ $k->link_katalog ?? '#' }}" class="text-decoration-none">
            <div class="card shadow-sm w-100 my-4">
                <div class="card-body row">
                    <div class="col-1 justify-content-center">
                        <img src="{{ asset('images/logo-dameulos.png') }}" alt="logo dame ulos" class="img-fluid">
                    </div>
                    <div class="col-11 text-center">
                        <h3 class="text-uppercase font-weight-bold">{{ $k->nama }}</h3>
                    </div>
                </div>
            </div>
        </a>
