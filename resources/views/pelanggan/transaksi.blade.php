                                ...
                                <div class="card shadow-sm">
                                    <div class="card-header bg-primary text-white">
                                        <div class="row align-items-center">
                                            <div class="col-md-6">
                                                <h5 class="mb-0">
                                                    <a href="{{ route("pelanggan.checkout.success", $item->kode_transaksi) }}"
                                                    ...
                                                    <tbody>
                                                        @foreach ($item->detailTransaksi as $detail)
                                                            <tr>
                                                                ...
                                                                <td><strong>Rp
                                                                        {{ number_format($detail->total_harga, 0, ",", ".") }}</strong>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                            ...
                                            <div class="col-md-4">
                                                <div class="shopping__cart__total">
                                                    ...
                                                    <ul>
                                                            ...
                                                            @if ($item->status == "pending" || $item->status == "dikonfirmasi")
                                                                <small>
                                                                    <button type="button"
                                                                        ...
                                                                        onclick="updateStatus('{{ $item->kode_transaksi }}')">
                                                                        <i class="fa fa-refresh"></i> Update Status
                                                                    </button>
                                                                </small>
                                                            @endif

                                                            @if ($item->status == "dibayar" || $item->status == "dikonfirmasi")
                                                                <small>
                                                                    <a href="{{ route("transaksi.edit-detail", $item->id) }}"
                                                        ...
                                                        <li>Ongkir <span>Rp
                                                                {{ number_format($item->ongkir, 0, ",", ".") }}</span></li>
                                                        <li>Total <span>Rp
                                                                {{ number_format($item->total, 0, ",", ".") }}</span></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if ($item->pengiriman)
                                            ...
                                            @if ($item->status == "dikirim")
                                                <button data-id="{{ $item->id }}"
                                                    class="primary-btn mt-2 terima-pesanan">Terima Pesanan</button>
                                            @endif
                                        @endif
                                    </div>
                                </div>
