...
@section('judul', 'Edit Data Manajer')

@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4>Edit Data Manajer: {{ $manajer->name }}</h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('manajer.update', $manajer->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('no_telp') is-invalid @enderror"
                            ...
                            id="no_telp"
                            name="no_telp"
                            value="{{ old('no_telp') ?? $manajer->no_telp }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('alamat') is-invalid @enderror"
                            ...
                            name="alamat"
                            rows="3"
                            placeholder="Masukkan alamat lengkap (opsional)">{{ old('alamat') ?? $manajer->alamat }}</textarea>
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        ...
                        <a href="{{ route('manajer.show', $manajer->id) }}" class="btn btn-secondary">
