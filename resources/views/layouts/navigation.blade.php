@php
    $transaksiBaru = \App\Models\Transaksi::where("preorder", false)
        ->whereIn("status", ["pending", "dibayar"])
        ->count();
    $preorderBaru = \App\Models\Transaksi::where("preorder", true)
        ->whereIn("status", ["pending", "dibayar"])
        ->count();
@endphp
<!-- [ Sidebar Menu ] start -->
    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{ route("transaksi.index") }}" class="pc-link">
                        ...
                        <span class="pc-mtext">Transaksi <span
                                class="badge bg-light-info">+{{ $transaksiBaru }}</span></span>
                    </a>
                </li>
                <li class="pc-item">
                    <a href="{{ route("preorder.index") }}" class="pc-link">
                        ...
                        <span class="pc-mtext">Pre-Order <span
                                class="badge bg-light-info">+{{ $preorderBaru }}</span></span>
                    </a>
                </li>
                <li class="pc-item">
                ...
                <li class="pc-item">
                    <a href="{{ route("pengembalian-dana.index") }}" class="pc-link">
                        <span class="pc-micon"><i class="ti ti-arrow-back"></i></span>
