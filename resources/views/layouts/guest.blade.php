...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__nav__option">
            <a href="#" class="search-switch"><img src="{{ asset("home/img/icon/search.png") }}"
                    alt=""></a>
            <a class="text-decoration-none text-black" href="{{ route("pelanggan.keranjang.index") }}"><i
                    class="fa-solid fa-cart-shopping"></i><span
                    class="badge badge-info">{{ $keranjang > 0 ? " ($keranjang)" : "" }}</span></a>
        </div>
        ...
        @if (Auth::check())
            <div class="mobile-user-menu" style="border-top: 1px solid #eee; margin-top: 15px; padding-top: 15px;">
                ...
                @if (Auth::user()->role == "pelanggan")
                    ...
                    <a href="{{ route("pelanggan.pengembalian-dana.index") }}" class="mobile-menu-item">
                        <i class="fa fa-arrow-left"></i> Pengembalian Dana
                    </a>
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="/"><img src="{{ asset("images/logo-dameulos.png") }}" alt="logo dameulos"
                                style="width: 80px"></a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu ">
                        <ul>
                            <li class="{{ Route::currentRouteName() == "pelanggan.home" ? "active" : "" }}"><a
                                    href="/">Home</a></li>
                            <li class="{{ Route::currentRouteName() == "pelanggan.katalog" ? "active" : "" }}"><a
                                    href="{{ route("pelanggan.katalog") }}">Katalog</a></li>
                            <li class="{{ Route::currentRouteName() == "pelanggan.tentang-kami" ? "active" : "" }}"><a
                                    href="{{ route("pelanggan.tentang-kami") }}">Tentang Kami</a></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a class="text-decoration-none text-white" href="{{ route("pelanggan.keranjang.index") }}"><i
                                class="fa-solid fa-cart-shopping"></i>{!! $keranjang > 0 ? '<span class="text-white badge-pill badge-danger">' . $keranjang . "</span>" : "" !!}</a>
                        @if (Auth::check())
                            <div class="dropdown" style="display: inline-block;">
                                <a href="#" class="dropdown-toggle text-decoration-none text-white"
                                    id="userDropdown" style="text-decoration: none;">
                                    <i class="fa fa-user"></i> {{ Auth::user()->name }}
                                </a>
                                <div class="dropdown-menu" id="userDropdownMenu">
                                    @if (Auth::user()->role == "pelanggan")
                                        ...
                                        <a class="dropdown-item text-black"
                                            href="{{ route("pelanggan.pengembalian-dana.index") }}">
                                            <i class="fa fa-arrow-left"></i> Pengembalian Dana
                                        </a>
                                        <a class="dropdown-item text-black"
                        ...
                        @else
                            <a class="text-decoration-none text-white" href="{{ route("login") }}"
                                style="margin-left: 10px;"><i class="fa fa-sign-in"></i> Login</a>
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="/"><img src="{{ asset("images/logo-dameulos.png") }}" class="w-50"
                                    alt="logo dameulos"></a>
                        </div>
                        <p>Jl. Gereja Dame, Saitnihuta, Huta Toruan I.Tarutung, Tapanuli Utara, Sumatera
                            Utara.Indonesia, 22411.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li><a href="https://www.instagram.com/dameulos/"><i
                                        class="fa-brands fa-instagram mr-2"></i>@dameulos</a></li>
                            <li><a href="https://www.tiktok.com/@dameulos"><i
                                        class="fa-brands fa-tiktok mr-2"></i>@dameulos</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 offset-lg-1 col-md-6 col-sm-6">
                    <div class="footer__widget">
                        <iframe class="w-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4039.293627132542!2d98.97371517502651!3d2.0054015979765216!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x302e6ffebb2f78df%3A0xd9b82ef76bdfcc5b!2sGALERI%20DAME%20ULOS!5e1!3m2!1sen!2sid!4v1753597225419!5m2!1sen!2sid"
